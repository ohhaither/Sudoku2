...
public class Sudoku2 {
    ...
    /**
     * Gera uma quadrícula 9x9 preenchidada com números de 1 a 9 e insere-a 
    ...
    */
    ...
    /**
     * Faz a leitura de um número inteiro no terminal  e certifica que este
     * encontre-se no intervalo indicado, apresentando uma mensagem de erro caso
     * não se encontre
     * @param scan leitor
	...
	boolean validade = true;
        int[] vetor = new int[matriz[0].length]; // recebe a linha/coluna/bloco 
        for (int i = 0; i < matriz.length; i++) {
            // linhas
            for (int j = 0; j < matriz.length; j++)
                vetor[j] = matriz[i][j]; // o vetor recebe uma linha da matriz por vez
            ...
            // colunas
            for (int j = 0; j < matriz.length; j++)
                vetor[j] = matriz[j][i]; // o vetor recebe uma coluna da matriz por vez 
            if (!validadeDoVetor(vetor)) { // verificação da validade do vetor
                validade = false;
                break;
            }
    ...
    /** 
     * Restringe o valor de e2 de acordo com o valor de e1, garantindo que ambos 
     * encontram-se na mesma faixa da quadrícula, sendo que e1 e e2 representam 
     * índices de linhas ou colunas. Recebe e1 com indexagem de 0 a 8 e retorna 
     * e2 com indexagem de 1 a 9.
     * @param scan leitor
     * @param msgErro mensagem apresentada caso e1 e e2 não se encontrem na mesma faixa
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 8: // inserção de quadrícula
                    ...
                    forma a evitar bugs na eventualidade da inserção de valores excessivos */
